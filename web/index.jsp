...
<div class="container-fluid">
    <div class="row">
        ...
        Pretty much all of this has to change. we need to rewrite it all for our form. probably easiest to work
        off what is already here though instead of deleting it
